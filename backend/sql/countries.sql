...
CREATE TABLE world.countries (
	...
	ccn3				SMALLINT NOT NULL,
	continent_id		SMALLINT NOT NULL 			DEFAULT 0,
	sub_continent_id	SMALLINT NOT NULL			DEFAULT 0
);


INSERT INTO world.countries (id, name, cca2, cca3, ccn3, continent_id, sub_continent_id) VALUES 
...
ALTER TABLE world.countries DROP column cca2;
ALTER TABLE world.countries DROP column cca3;
ALTER TABLE world.countries DROP column ccn3;
ALTER TABLE world.countries DROP column sub_continent_id;


-- Synchronize sequence values (Primary Index values)
SELECT setval(pg_get_serial_sequence('world.countries', 'id'), coalesce(max(id),0) + 1, false) FROM world.countries;